...
\section*{Software Architecture and Interface}
  ...
  \subsection{Interfaces}
    describe ways to ``talk to'' \texttt{bayesim}.
...
\section*{Application Examples}
  ...
  \subsection{Example with Real Data}
    \begin{itemize}
      \item more practical example - probably fitting resistive diode to the same SnS data we used in the Joule paper
      \item figure 4 showing PMF (animation in ESI) and comparison of JV curves
    \end{itemize}
