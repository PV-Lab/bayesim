...
Kinematics
----------
Probably the simplest example, explained on the :doc:`bayesics` page. It exists in the `Github repo <https://github.com/PV-Lab/bayesim>`_ under ``examples/kinematics/kinematics.py`` and you can run it all in one go from a Terminal or step-by-step in an IDE like Spyder.
